package com.electraproject.presenter.fragments;
...
import com.electraproject.protocols.messageexchange.MessageExchangeNetworkHelper;
import com.electraproject.protocols.messageexchange.MessageExchangeService;
import com.electraproject.protocols.messageexchange.entities.LinkMetaData;
import com.electraproject.protocols.messageexchange.entities.ServiceMetaData;
import com.electraproject.tools.util.Utils;

import java.util.List;

import static com.electraproject.tools.util.BRConstants.STRING_RESOURCES_FILENAME;
import static com.electraproject.tools.util.BRConstants.TYPEFACE_PATH_CIRCULARPRO_BOLD;
import static com.electraproject.tools.util.BRConstants.TYPEFACE_PATH_CIRCULARPRO_BOOK;
