package com.electraproject.wallet.wallets.bitcoin;
...
import com.electraproject.presenter.customviews.BRToast;
import com.electraproject.presenter.entities.BRMerkleBlockEntity;
import com.electraproject.presenter.entities.BRPeerEntity;
import com.electraproject.presenter.entities.BRTransactionEntity;
import com.electraproject.presenter.entities.BlockEntity;
import com.electraproject.presenter.entities.CurrencyEntity;
import com.electraproject.presenter.entities.PeerEntity;
import com.electraproject.presenter.entities.TxUiHolder;
import com.electraproject.presenter.interfaces.BROnSignalCompletion;
import com.electraproject.tools.animation.BRDialog;
import com.electraproject.tools.animation.UiUtils;
import com.electraproject.tools.manager.BRApiManager;
import com.electraproject.tools.manager.BRNotificationManager;
...
import com.electraproject.tools.sqlite.BtcBchTransactionDataStore;
import com.electraproject.tools.sqlite.MerkleBlockDataSource;
import com.electraproject.tools.sqlite.PeerDataSource;
import com.electraproject.tools.sqlite.RatesDataSource;
import com.electraproject.tools.sqlite.TransactionStorageManager;
...
import com.electraproject.wallet.configs.WalletUiConfiguration;
import com.electraproject.wallet.wallets.CryptoAddress;
import com.electraproject.wallet.wallets.CryptoTransaction;
import com.electraproject.wallet.wallets.WalletManagerHelper;
...
import static com.electraproject.tools.util.BRConstants.ROUNDING_MODE;
...
public abstract class BaseBitcoinWalletManager extends BRCoreWalletManager implements BaseWalletManager {
    ...
    public BigDecimal getFiatForSmallestCrypto(Context app, BigDecimal amount, CurrencyEntity ent) {
        ...
        amount = amount.multiply(getFiatExchangeRate(app));
